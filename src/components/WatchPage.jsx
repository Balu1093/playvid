...
const WatchPage = () => {
  ...
  if (!video.length || !channel.length) return;
...
return (
    <div className={`${navToggle && 'md:ml-[300px] lg:ml-[300px]'} transition-all duration-500 w-full md:w-9/12 2xl:mx-auto`}>
      ...
      <div className='w-[97%] mx-auto h-[300px] md:w-[900px] lg:w-[1200px] lg:h-[700px]'>
      ...
      <div className='w-11/12 md:w-full mx-auto ml-5 h-[450px] 2xl:w-3/12 2xl:h-[700px] border-t border-l border-r border-black mt-4 2xl:mt-0 overflow-y-hidden'>
      <LiveChatContainer/>
      </div>
      </div>
      ...
      <div className='mt-5 p-4 w-full md:w-[1200px]'>
        <CommentsContainer/>
      </div>
      </div>
  )
